let header_en = `
    <div class="nav_bar_">
        <header class="header flex">
            <div class="flex bar">
                <p>An electronic library and cultural platform based in the UAE.</p>
                <ul>
                    <li><a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24"
                                fill="currentColor" stroke-width="2" class="ai ai-SnapchatFill">
                                <g clip-path="url(#clip0_822_337)">
                                    <path
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="/index_en.html">
                    <img src="https://book.queenarnor.com/images/logo.png" alt="Logo">
                </a>
                ...
                <div class="d-flex align-items-center order-lg-last">
                    ...
                    <div class="icon-container" id="fav-icon">
                        <a href="../pages/favorite_en.html">
                            <svg width="22" height="19" viewBox="0 0 22 19" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M2.75 9.99999C0.6875 7.24999 1.375 3.12499 4.8125 1.74999C8.25 0.37499 10.3125 3.12499 11 4.49999C11.6875 3.12499 14.4375 0.37499 17.875 1.74999C21.3125 3.12499 21.3125 7.24999 19.25 9.99999C17.1875 12.75 11 18.25 11 18.25C11 18.25 4.8125 12.75 2.75 9.99999Z"
                                    stroke="#222222" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </svg>
                        </a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu trans">
                            <li><a class="dropdown-item en_ar" href="/index.html">Ar</a></li>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="mainNavbar">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav  mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link active" href="/index_en.html">Home</a></li>

                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Library</a>
                                <ul class="dropdown-menu trans">
                                    <li><a class="dropdown-item" href="#">Physical Books</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu trans">
                                    ...
                                    <li><a class="dropdown-item" href="#">Household Items</a></li>
                                </ul>
                            </li>
...
<div class="footer">
    <div class="column footer-logo">
        <div class="flex">
            <div class="flex_icon">
                <img src="../images/logo.png" alt="Al Jazeera Library Logo">
                <p>An electronic library and cultural platform based in the UAE.</p>
            </div>
    ...
    <div class="grid_footer">
        <div class="column">
            <h3>Sections</h3>
            <a href="#">Home</a>
            <a href="../pages/About_en.html">About Us</a>
            <a href="../pages/About_en.html">Authors</a>
            <a href="../pages/Publishing_en.html">Publishing House</a>
            <a href="../pages/Blogs_en.html">Blog</a>
            <a href="../pages/Contact_en.html">Contact Us</a>
        </div>
        <div class="column">
            <h3>Other Links</h3>
...
<div class="flex foot">
    <p style="text-align: center; font-family: 'Cairo', sans-serif;">
        © 2025 All rights reserved to (<strong>Al Jazeera Library</strong>)
    </p>
</div>
...
let nav_en = document.getElementById("nav_en");

let foot_en = document.getElementById("foot_en");

nav_en.innerHTML = header_en;
foot_en.innerHTML = footer_en;
