...
<div class="nav_bar_">
            <header class="header flex">
                <div class="flex bar">
                    ...
                    <ul>
                        <li><a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="currentColor" stroke-width="2" class="ai ai-SnapchatFill">
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"></path>
                        ...
                        <li>
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="currentColor" stroke-width="2" class="ai ai-InstagramFill">
                        ...
                        <li>
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="currentColor" stroke-width="2" class="ai ai-FacebookFill">
...
<footer>
            ...
            <div class="footer">
                <div class="column footer-logo">
                    <div class="flex">
                        <div class="flex_icon">
                            <img src="../images/logo.png" alt="لوجو مكتبة الجزيرة">
                            <p>مكتبة الكترونية ومنصة ثقافية مقرها الامارات.</p>
                        </div>
                ...
                <div class="column books-img">
                    <img src="../images/book.png" alt="كتب">
                </div>
            </div>

            <div class="flex foot">
                <p style="text-align: center; font-family: 'Cairo', sans-serif;">
                    © 2025 جميع الحقوق محفوظة لـ (<strong>مكتبة الجزيرة </strong>)
                </p>
            </div>
        </footer>
`;

let nav_ar = document.getElementById("nav_ar");

let foot_ar = document.getElementById("foot_ar");

nav_ar.innerHTML = header_ar;
foot_ar.innerHTML = footer_ar;
